...
{
    class Karkhana_Issue_Function
    {

        Operation Ope = new Operation();
        
        public int InsertUpdate(Karkhana_Issue_Property pProperty)
        {
            ...
            Request.AddParameter("@IssueDate", pProperty.IssueDate, DbType.String, ParameterDirection.Input);
            Request.AddParameter("@ReturnDate", "", DbType.String, ParameterDirection.Input);
            ...
            Request.AddParameter("@Cts", pProperty.Vajan, DbType.Double, ParameterDirection.Input);
        ...
        public int Delete(int Id, int KarkhanaId, string NotNo, int KatNo)
        {
            Request Request = new Request();
            ...
            Request.AddParameter("@KatNo", KatNo, DbType.Int32, ParameterDirection.Input);
            Request.AddParameter("@ReturnValue", 0, DbType.Int32, ParameterDirection.Output);
        ...
        public string CheckNotNoIssue(string SearchParam, string TableName, string fieldToFind)
        {
            string RetValue = Ope.FindText(Operation.ConnectionString1, TableName, fieldToFind, SearchParam);
