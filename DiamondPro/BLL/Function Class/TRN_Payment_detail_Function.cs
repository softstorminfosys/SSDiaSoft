...
namespace DiamondPro.BLL.Function_Class
{
    public class TRN_Payment_detail_Function
    {
        ...
        {            
            ...
            Request.AddParameter("@VechanDate", pProperty.KharidiDate, DbType.String, ParameterDirection.Input);
            Request.AddParameter("@VechanNo", pProperty.NotNo, DbType.String, ParameterDirection.Input);
            ...
            Request.AddParameter("@AngadiyaAmt", pProperty.AngadiyaAmt, DbType.Double, ParameterDirection.Input);
        ...
        public DataTable FillVechanNo(string PSearchParam)
        {
            ...
            Request.CommandType = CommandType.StoredProcedure;
            Request.ComandText1 = "Get_VechanNo_For_Search";
